...
local UI_GROUP_ORDER = { "chopMedal", "minerMedal", "chefMedal", "handyMedal", "harvestMedal", "plantMedal", "wisdomMedal", "speedMedal", "childMedal", "shadowmagicMedal", "naughtyMedal", "fishingMedal", "bathfireMedal", "justiceMedal", "autoexam", "tributeAnswer" }
--非自动装备组的开关中文名
