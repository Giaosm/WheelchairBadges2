...
modimport("scripts/helper_equip_align.lua")--自动装备对齐(应佩戴vs实际佩戴，缺佩临时剥假标签)
...
modimport("scripts/helper_treasure_master.lua")--寻宝大师(藏宝图部署一次直接在地图标出宝藏位置)

--通用半透明投影(资源由prefab自身声明)
PrefabFiles =
{
	"helper_projection",
}
